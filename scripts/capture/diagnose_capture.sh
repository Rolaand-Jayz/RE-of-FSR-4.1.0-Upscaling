...
CAPTURE_SO="/mnt/workdrive/fsr-re/tools/fsr4_capture.so"
PROXY_DLL="/mnt/workdrive/fsr-re/tools/ffx_proxy.dll"
...
echo "   RENDERDOC_CAPTUREFILE=/mnt/workdrive/fsr-re/runtime-capture/fsr4_ff7r \\"
echo "   VKD3D_DEBUG=trace \\"
echo "   VKD3D_SHADER_DUMP_PATH=/mnt/workdrive/fsr-re/runtime-capture/vkd3d-shaders \\"
echo "   %command%"
echo ""
echo " Method 2 — Vulkan LD_PRELOAD (dispatch logging):"
echo "   Steam launch options:"
echo "   LD_PRELOAD=/mnt/workdrive/fsr-re/tools/fsr4_capture.so \\"
echo "   %command%"
echo ""
echo " Method 3 — FFX Proxy DLL (API-level):"
echo "   bash /mnt/workdrive/fsr-re/tools/setup_capture.sh install-proxy"
